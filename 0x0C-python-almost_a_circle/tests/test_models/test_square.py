...
class Test_Square_stdout(unittest.TestCase):
    """Test cases for testing __str__ and display of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """A function to Captures and returns text printed to stdout."""
    ...
    def test_str_method_print_size(self):
        s = Square(4)
        capture = Test_Square_stdout.capture_stdout(s, "print")
    ...
    def test_display_size(self):
        s = Square(2, 0, 0, 9)
        capture = Test_Square_stdout.capture_stdout(s, "display")
        self.assertEqual("##\n##\n", capture.getvalue())
...
class Test_Square_update_args(unittest.TestCase):
    """Test cases for testing update args method of the Square class."""
...
class Test_Square_update_kwargs(unittest.TestCase):
    """Test_cases for testing update kwargs method of Square class."""
...
class Test_Square_to_dictionary(unittest.TestCase):
    """Test cases for testing to_dictionary method of the Square class."""
...
class Test_Square_instantiation(unittest.TestCase):
    """Test cases for testing instantiation of class Square."""
...
class Test_Square_size(unittest.TestCase):
    """Test cases for testing size initialization of the Square class."""
...
class Test_Square_x(unittest.TestCase):
    """Test cases for testing initialization of Square x attribute."""
...
class Test_Square_y(unittest.TestCase):
    """Test cases for testing initialization of Square y attribute."""
...
class Test_Square_order_of_initialization(unittest.TestCase):
    """Test cases for testing order of Square attribute initialization."""
...
class Test_Square_area(unittest.TestCase):
    """Test cases for testing the area method of the Square class."""
