...
class Test_Base_load_from_file_csv(unittest.TestCase):
    """Test cases for testing load_from_file_csv method of class Base."""
...
class Test_Base_instantiation(unittest.TestCase):
    """Test cases for testing instantiation of class Base."""
...
class Test_Base_to_json_string(unittest.TestCase):
    """Test cases for testing to_json_string method of class Base."""
...
class Test_Base_save_to_file(unittest.TestCase):
    """Test cases for testing save_to_file method of class Base."""
...
class Test_Base_from_json_string(unittest.TestCase):
    """Test cases for testing from_json_string method of Base class."""
...
class Test_Base_create(unittest.TestCase):
    """Test Cases for testing create method of Base class."""
...
class Test_Base_load_from_file(unittest.TestCase):
    """Test cases for testing load_from_file_method of Base class."""
